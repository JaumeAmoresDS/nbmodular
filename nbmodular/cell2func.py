...
from .utils import set_handle_and_log_level, get_config
...
class FunctionProcessor(Bunch):
    ...
    def update_code(
        ...
        display=False,
        run=True,
        ns_not_run=False,  # create function in name space if not run
    ) -> None:
        """
...
class CellProcessor:
    ...
    def __init__(
        ...
        io_folder=None,
        test_io_folder=None,
        io_locals_root_path="locals",
        test_io_locals_root_path="locals",
        io_result_root_path="results",
        test_io_result_root_path="results",
        load_args={},
        test_load_args={},
        save_args={},
        test_save_args={},
        ...
        pipe=True,
        test_pipe=False,
        load_capture_disk=False,
        save_capture_disk=False,
        load_capture_memory=False,
        save_capture_memory=False,
        test_load_capture_disk=False,
        test_save_capture_disk=False,
        test_load_capture_memory=False,
        test_save_capture_memory=False,
        write=False,
        test_write=False,
        pipe_name=None,
        ...
        **kwargs,
        ...
        self.parser.add_argument(
            ...
            action="store_true",
            default=None,
            help="create function in namespace regardless of whether the function's code is run",
        )
        self.parser.add_argument(
            "--copy-locals",
            action="store_true",
...
"""
    ...
    def create_function(
        ...
        **kwargs,
        ...
        if defined and this_function.run:
            # create variables with the same name as the function keyword parameters,
    ...
    def create_function_and_run_code(
        ...
        **kwargs,
        ...
        elif self.current_function.ns_not_run:
    ...
    def update_pipeline(
        ...
        if current_function.test and not current_function.data:
            current_function.update_code(run=run)
        ...
        for function in function_list_for_posterior_analysis:
            ...
            if (
                ...
                function.update_code(
                    ...
                    display=False,
                    run=function.run,
                    ns_not_run=function.ns_not_run,
                )
        ...
        **kwargs,
        ...
        if this_function.pipe:
            ...
            self.register_pipeline(
                pipeline_name_or_default=pipe_name,
                pipeline_in_namespace=this_function.run or this_function.ns_not_run,
            )
        else:
...
"""
    ...
    def register_pipeline(
        self, pipeline_name_or_default="default_pipeline", pipeline_in_namespace=False
    ):
        if (
