...
# %% auto 0
__all__ = ['get_non_callable_ipython', 'get_non_callable', 'get_ast', 'FunctionProcessor', 'update_cell_code',
           'add_function_to_list', 'get_args_and_defaults', 'get_args_and_defaults_from_function_in_cell',
