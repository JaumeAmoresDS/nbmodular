...
class CellProcessor:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.parser.add_argument(
            "--not-load", action="store_true", help="load variables"
        )
        self.parser.add_argument("--save", action="store_true", help="save variables")
        self.parser.add_argument(
            "--not-save", action="store_true", help="save variables"
        )
        self.parser.add_argument(
            "--io-code", action="store_true", help="add I/O code to function"
        )
        self.parser.add_argument(
            "--not-io-code", action="store_true", help="do not add I/O code to function"
        )
        self.parser.add_argument(
            "--save-arg",
            action="store_true",
        ...
        self.parser.add_argument(
            "--not-save-arg",
            action="store_true",
            help="do not have save=True as default arg value in function",
        )
        self.parser.add_argument(
            "--load-arg",
            action="store_true",
        ...
        self.parser.add_argument(
            "--not-load-arg",
            action="store_true",
            help="do not have load=True as default arg value in function",
        )
        self.parser.add_argument(
            "--io-type",
            type=str,
        ...
        self.parser.add_argument(
            "--not-io-locals",
            action="store_true",
            help="do not save/load local variables of function",
        )
        self.parser.add_argument(
            "--io-root-path",
            type=str,
        ...
        self.parser.add_argument(
            ...
            "--not-run",
            action="store_true",
            help="do not execute the contents of the cell",
        )
        self.parser.add_argument(
            "--not-store",
            action="store_true",
            help="do not store local values from cell",
        )
        self.parser.add_argument(
            "--not-store-locals-in-disk",
            action="store_true",
            help="do not store local values from cell in disk",
        )
        self.parser.add_argument(
            "--copy-locals",
            action="store_true",
        ...
        self.parser.add_argument(
            "--not-pipe",
            action="store_true",
            help="Do not insert function into pipeline.",
        )
...
"""
    ...
    def set_function_attr(self, this_function, attr, value, test, negate=False):
        ...
        value = (
            ...
            else default_value if value is None else value
        )
        ...
        if this_function.io_locals:
            if not test:
                this_function.io_root_path = (
                    self.overriden_io_locals_root_path
                    if self.overriden_io_locals_root_path is not None
                    else (
                ...
                this_function.io_root_path = (
                    self.overriden_test_io_locals_root_path
                    if self.overriden_test_io_locals_root_path is not None
                    else (
            ...
            if not test:
                this_function.io_root_path = (
                    self.overriden_io_result_root_path
                    if self.overriden_io_result_root_path is not None
                    else (
                ...
                this_function.io_root_path = (
                    self.overriden_test_io_result_root_path
                    if self.overriden_test_io_result_root_path is not None
                    else (
