...
# %% auto 0
__all__ = ['nb1', 'mixed_nb1', 'complete_nb1', 'py1', 'convert_nested_nb_cells_to_dicts', 'parse_nb_sections', 'text2nb',
           'texts2nbs', 'nb2text', 'nbs2text', 'printnb', 'strip_nb', 'read_nbs_in_repo', 'read_pymodules_in_repo',
           'read_cell_types_lists', 'read_cell_types_lists_in_repo', 'read_content_in_repo', 'derive_nb_paths',
           'derive_py_paths', 'derive_cell_types_paths', 'derive_all_paths', 'read_nbs', 'compare_nb', 'compare_nbs',
